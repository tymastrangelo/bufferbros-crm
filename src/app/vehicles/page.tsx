  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-100">Vehicles</h1>
        <Link
          href="/vehicles/new"
              ...
              {vehicles.length > 0 ? (
                vehicles.map((vehicle) => (
                  <tr key={vehicle.id} className="hover:bg-gray-800">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100">{vehicle.year} {vehicle.make} {vehicle.model}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{vehicle.clients?.full_name || 'N/A'}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{vehicle.license_plate || 'N/A'}</td>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-4 text-center text-sm text-gray-400">No vehicles found.</td>
                </tr>
              )}
            </tbody>
          </table>
